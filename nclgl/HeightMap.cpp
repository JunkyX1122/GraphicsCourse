...
HeightMap::HeightMap(const std::string& name)
{
	...
	float overallScale = 16;
	Vector3 vertexScale = Vector3(overallScale, 1.0f, overallScale);
	Vector2 textureScale = Vector2(1.0f / (overallScale * 1.0f), 1.0f / (overallScale * 1.0f));
